    ...
    return (
        <main>
            <section className="relative flex items-end overflow-hidden">
                ...
                <div className="relative z-10 w-full p-6 pt-52 xl:pb-16 max-w-7xl mx-auto backdrop-blur-xs">
                    <div className="max-w-2xl xl:max-w-3xl text-on-primary">
                        ...
                        {/*     Nivel Institucional */}
                        {/* </span> */}
                        <h1 className="text-5xl md:text-6xl xl:text-7xl leading-snug md:leading-tight mb-3 tracking-tighter">
            ...
            <section className="bg-surface p-6 py-12">
                <div className="max-w-7xl mx-auto space-y-12">
                    <div className="text-on-surface lg:py-6">
                        <div className="md:border-l-4 md:border-sbr-blue-light md:pl-6 py-3">
                            <h2 className="flex flex-col gap-3 font-semibold text-4xl tracking-tight leading-none mb-4">
                                ...
                                <span className="w-1/6 h-1 bg-sbr-green-light inline-block text-[0px] md:hidden">decoration</span>
                            </h2>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                        {
                            projects.map((project) => (
                                <ProjectCard className="" project={project} key={project.id} />
                            ))
                        }
                        <div className="col-span-full group bg-surface-container-lowest rounded-xl overflow-hidden border-2 border-primary/5">
                            <div className="h-full flex flex-col items-center justify-center p-8 text-center bg-surface-container-low space-y-3">
                                ...
                                <p className="text-outline text-sm leading-relaxed">
                                    Estamos trabajando en nuevos proyectos. Pronto tendremos más ofertas para ti.
                                </p>
                            </div>
                        </div>
                    </div>
