...
export function ConnectIcon({ className }: { className?: string }) {
    return (
        <svg className={cn("aspect-square size-6 fill-current", className)} fill="currentColor" stroke="none" viewBox="0 0 16 16" version="1.1" xmlns="http://www.w3.org/2000/svg">
