...
import { deleteUserImageOpts, uploadUserImageOpts } from "@/queries/users";
...
export function ProfileImageCard({
    ...
    const uploadMut = useMutation(uploadUserImageOpts(userId));
    const deleteMut = useMutation(deleteUserImageOpts(userId));
